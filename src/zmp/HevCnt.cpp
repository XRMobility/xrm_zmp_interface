...
void HevCnt::UpdateDriveState(REP_DRIVE_INFO_INDEX index)
{
  switch (index)
  {
    ...
    case REP_CRUISE_STATE:
      ...
      break;
    case REP_DTC_STATUS:  //_hevCnt->GetDtcStatus((char&)_otherInf.dtcData1, (char&)_otherInf.dtcData2,
                          //(char&)_otherInf.dtcData3,
      //(char&)_otherInf.dtcData4, (char&)_otherInf.dtcData5, (char&)_otherInf.dtcData6, (char&)_otherInf.dtcData7,
...
void HevCnt::UpdateBattState(REP_BATT_INFO_INDEX index)
{
  ...
  {
    case REP_BATT_INFO:
      _hevCnt->GetBattInfo((float&)_battInf.soc, (int&)_battInf.max_temp, (int&)_battInf.min_temp,
