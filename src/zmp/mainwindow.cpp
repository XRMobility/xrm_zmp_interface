...
//    this->addToolBar(getToolBar(this));
    ...
    connect(ui->pushButton_drvShiftSet_P, SIGNAL(clicked()), this, SLOT(sndDrvShiftP()));
    ...
    connect(ui->pushButton_errClear, SIGNAL(clicked()), this, SLOT(SndErrClear()));
    connect(ui->pushButton_firm_version_Get, SIGNAL(clicked()), this, SLOT(SndVersionReq()));
    ...
    connect(ui->pushButton_configEmergencyBrakeRate_Get, SIGNAL(clicked()), this, SLOT(GetConfEmergencyBrakeRate()));
    connect(ui->pushButton_configEmergencyBrakeRate_Set, SIGNAL(clicked()), this, SLOT(SetConfEmergencyBrakeRate()));
